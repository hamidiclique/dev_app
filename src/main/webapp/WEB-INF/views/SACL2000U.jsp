...
<script
	src="${pageContext.request.contextPath}/resources/js/select_box.js"></script>
<style type="text/css">
#lstBox1, #lstBox2 {
	height: 200px;
	width: 180px;
	...
	<div class="rightPart">
		<c:choose>
			<c:when test="${empty message}">
				...
				<br>
				<form:form action="submit-user-role-maintenance-update"
					modelAttribute="rfMapDto" name="SACL2000U"
					...
					<table class="TableContent" width="80%" align="center">
						...
						<tr>
							...
							<td class="FormInputColor"><form:input type="text"
									name="roleId" path="roleId" required="true" readonly="true"></form:input></td>
						</tr>
						<tr>
					...
					<table id="functionsTable" class="TableContent" width="80%"
						...
						<tr>
							<td class="FormInputColor">
								<div align="center">
									<form:select path="leftoutFungrpList" id="lstBox1"
										name="lstBox1">
							...
							<td class="FormInputColor">
								<div align="center">
									<input type="button" id="btnAllRight"
										value="&nbsp;&gt;&gt;&nbsp;" /><br> <br> <input
										type="button" id="btnRight" value="&nbsp;&gt;&nbsp;" /><br>
									<br> <input type="button" id="btnLeft"
										value="&nbsp;&lt;&nbsp;" /><br> <br> <input
										type="button" id="btnAllLeft" value="&nbsp;&lt;&lt;&nbsp;" /><br>
									<br>
								</div>
							</td>
							<td class="FormInputColor">
