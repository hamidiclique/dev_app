...
<script src="${pageContext.request.contextPath}/resources/js/SACL2000A.js"></script>	
<style type="text/css">
	#lstBox1, #lstBox2 {
		height: 200px;
		width: 180px;
...
<body>
	...
	<form:form action="submit-user-role-maintenance-add" modelAttribute="rfMapDto" name="SACL2000A" onsubmit="return doUpdate();">
