	...
	<div class="rightPart">
		<c:choose>
			<c:when test="${empty message}">
				...
				<br>
				<form:form action="submit-branch-maintenance-add" modelAttribute="branch">
					<table class="TableContent" width="80%" align="center">
						<tr>
							...
							<td class="FormInputColor" colspan="3"><form:input
									type="text" maxlength="50" path="branchName" required="true"></form:input></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="FormInputColor" colspan="3"><form:input
									type="text" maxlength="75" path="branchAddr2"></form:input></td>
						</tr>
						<tr>
						...
						<tr class="hidden">
							...
							<td class="FormInputColor"><form:input type="text" path="iso"></form:input></td>
						</tr>
						<tr>
						...
						<tr class="hidden">
							...
							<td class="FormInputColor"><form:input type="text" path="sequence"></form:input></td>
							<th class="FormCellBGColor">Sequence Length:</th>
							<td class="FormInputColor"><form:input type="text" path="sequenceLen"></form:input></td>
						</tr>
					</table>
					<table align="center" width="80%">
						<tr>
							<td>
								<p>
									<input type="submit" class="button" id="" value="Add" /> 
