 ...
 */
@Embeddable
public class TFungrpFunMapPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TFungrpFunMapPK)) {
			return false;
		}
		TFungrpFunMapPK castOther = (TFungrpFunMapPK)other;
		return 
