...
public class TRoleFungrpMap implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TRoleFungrpMapPK id;
	...
	public TRoleFungrpMap() {
	}

	public TRoleFungrpMapPK getId() {
		return this.id;
	}

	public void setId(TRoleFungrpMapPK id) {
		this.id = id;
	}
