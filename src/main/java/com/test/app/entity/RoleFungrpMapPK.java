 ...
 */
@Embeddable
public class RoleFungrpMapPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof RoleFungrpMapPK)) {
			return false;
		}
		RoleFungrpMapPK castOther = (RoleFungrpMapPK)other;
		return 
