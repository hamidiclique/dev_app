 ...
 */
@Embeddable
public class ScreenFunMapPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ScreenFunMapPK)) {
			return false;
		}
		ScreenFunMapPK castOther = (ScreenFunMapPK)other;
		return 
